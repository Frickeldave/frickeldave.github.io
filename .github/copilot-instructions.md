...
die Orchestrierungs-Skripte, da diese Issue-Creation, AI-Commit-Messages und Quality Gates bündeln!

```bash
npm run deploy:dev   # Standard Command: Pusht auf dev (unterstützt direktes Arbeiten auf dev)
npm run deploy:dev -- --auto-cleanup # Non-interactive Mode für automatisierte Deployments
