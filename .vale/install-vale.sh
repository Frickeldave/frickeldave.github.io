...
mkdir -p ./.vale
timeout 60 curl -L --max-time 30 "https://github.com/errata-ai/vale/releases/download/v${VALE_VERSION}/${BINARY_NAME}" | tar -xz -C ./.vale || {
...
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_DE_frami.dic" -o ./.vale/dictionaries/de_DE.dic 2>/dev/null || echo "Warning: Could not download de_DE.dic"
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_DE_frami.aff" -o ./.vale/dictionaries/de_DE.aff 2>/dev/null || echo "Warning: Could not download de_DE.aff"

# Download Austrian German dictionary files
echo "Downloading Austrian German dictionary (de_AT)..."
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_AT_frami.dic" -o ./.vale/dictionaries/de_AT.dic 2>/dev/null || echo "Warning: Could not download de_AT.dic"
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_AT_frami.aff" -o ./.vale/dictionaries/de_AT.aff 2>/dev/null || echo "Warning: Could not download de_AT.aff"

# Download Swiss German dictionary files
echo "Downloading Swiss German dictionary (de_CH)..."
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_CH_frami.dic" -o ./.vale/dictionaries/de_CH.dic 2>/dev/null || echo "Warning: Could not download de_CH.dic"
timeout 30 curl -L --max-time 15 "https://cgit.freedesktop.org/libreoffice/dictionaries/plain/de/de_CH_frami.aff" -o ./.vale/dictionaries/de_CH.aff 2>/dev/null || echo "Warning: Could not download de_CH.aff"
...
echo "  - German dictionaries: .vale/dictionaries/ (de_DE, de_AT, de_CH)"
